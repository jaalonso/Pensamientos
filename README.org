...
* [[https://es.wikipedia.org/wiki/Aaron_Swartz][Aaron Swartz (1986-2013)]]
  + Sé curioso. Lee de todo. Prueba cosas nuevas. Creo que mucho de lo
    que la gente llama inteligencia se reduce a la curiosidad.

* [[https://es.wikipedia.org/wiki/Abate_Pierre][Abate Pierre (1912-2007)]]
  + Solo se posee lo que se es capaz de dar; si no, se es poseído.
...
* [[https://es.wikipedia.org/wiki/Abraham_Maslow][Abraham Maslow (1908-1970)]]
...
* [[https://es.wikipedia.org/wiki/Alain][Alain (1868-1951)]]
  + El deseo de seguridad y la sensación de inseguridad son lo
    mismo. Contener la respiración es perderla. Una sociedad basada en
    la búsqueda de seguridad no es más que una competición de retención
    de la respiración donde todos están tensos como un tambor y morados
    como una remolacha.
  + El hombre que tiene miedo sin peligro, inventa el peligro para
    justificar su miedo.
...
* [[https://es.wikipedia.org/wiki/Alan_Watts][Alan Watts (1915-1973)]]
  + El desapego significa no sentir ningún remordimiento por el pasado
    ...
    iluminación.
  + El hombre civilizado tiende a estar en un estado de preocupación,
    miedo y ansiedad crónicos, porque siempre se enfrenta no a la simple
    realidad de lo que sucede ante él, sino a las innumerables
    posibilidades de lo que podría suceder.
  ...
  + Intentar forzar una cerradura dobla la llave, por lo que un hombre
    verdaderamente inteligente nunca fuerza nada. En cambio, recurre al
    judo, la forma suave de ajustar las velas al viento, de seguir el
    ritmo y partir la madera a lo largo de la veta.
  ...
  + Lo que sentimos depende en un grado enorme e insospechado de lo que
    pensamos.
  + Muy feliz era el ciempiés, hasta que un sapo una vez, le preguntó
    ...
    hacer para correr.
  + Nos guste o no, el cambio siempre llega, y cuanto mayor es la
    resistencia, mayor es el dolor.
...
* [[https://es.wikipedia.org/wiki/Albert_Camus][Albert Camus (1913-1960)]]
  ...
  + En medio del invierno, aprendí por fin que había en mí un verano
    invencible.
  ...
  + La lucha misma hacia las cumbres basta para llenar el corazón de un
    hombre. Hay que imaginar a Sísifo feliz.
  + La vida es una suma de todas tus elecciones. Entonces, ¿qué estás
    haciendo hoy?
  + Lo absurdo nace de la confrontación entre la llamada humana y el
    silencio sin razón del mundo.
  + Me rebelo, luego somos.
  + Nadie se da cuenta de que algunas personas gastan una enorme energía
    simplemente para ser normales.
  + No ser nada para ser algo.
  ...
  + Si hay un pecado contra la vida, no consiste tal vez tanto en
    desesperar de ella como en esperar otra vida y sustraerse a la
    implacable grandeza de esta.
...
* [[https://es.wikipedia.org/wiki/Albert_Schweitzer][Albert Schweitzer (1875-1965)]]
...
* [[https://es.wikipedia.org/wiki/Aldous_Huxley][Aldous Huxley (1894-1963)]]
  ...
  + Lo que pensamos determina lo que somos y lo que hacemos, y,
...
* [[https://es.wikipedia.org/wiki/Alfred_North_Whitehead][Alfred North Whitehead (1861-1947)]]
  ...
  + Los mayores progresos de la civilización se experimentan
    inicialmente como sus peores amenazas.
...
* [[https://es.wikipedia.org/wiki/Alice_Herz-Sommer][Alice Herz-Sommer (1903-2014)]]
  + La vida es bella. Tienes que estar agradecido de que estemos
    viviendo. Dondequiera que mires hay belleza. Sé de las cosas malas,
    pero busco las buenas.
  + Mi elección en la vida es no lamentarme de nada.

* [[https://en.wikipedia.org/wiki/Alice_Munro][Alice Munro (1931-2024)]]
...
* [[https://es.wikipedia.org/wiki/Jean-Baptiste_Alphonse_Karr][Alphonse Karr (1808-1890)]]
...
* [[https://es.wikipedia.org/wiki/Ana%C3%AFs_Nin][Anaïs Nin (1903-1977)]]
  + No vemos las cosas como son, las vemos como somos.

* [[https://en.wikipedia.org/wiki/Anatole_France][Anatole France (1844-1924)]]
...
* [[https://bit.ly/37bBjJJ][André Gide (1889-1951)]]
...
* [[https://es.wikipedia.org/wiki/Andr%C3%A9_Maurois][André Maurois (1885-1967)]]
  + El arte de envejecer es el arte de conservar alguna esperanza.
  + La lectura de un buen libro es un diálogo incesante en que el libro
    habla y el alma contesta.
  + Sería necesario imponer esta regla: no repetir jamás una afirmación
    malévola sin verificar su contenido. Aunque es cierto que así nunca
    se hablaría de nada.
...
* [[https://es.wikipedia.org/wiki/Anthony_de_Mello][Anthony de Mello (1931-1987)]]
  + Comprende tu infelicidad, y ésta desaparecerá y dará paso al estado
    de felicidad.
  ...
  + Había un leñador que se agotaba malgastando su tiempo y sus energías
    en cortar madera con un hacha embotada, porque no tenía tiempo,
    según él, para detenerse a afilar la hoja.
  + Hay que disfrutar de todo, pero sin apegarse a nada. Cuando te
    desapegues, verás cómo disfrutas mucho más de todo, pues serás mucho
    más libre para recrearte en cada cosa sin quedar fijado a ninguna.
  ...
  + La infelicidad tiene una sola causa: las falsas creencias que
    albergas en tu mente; creencias tan difundidas, tan comúnmente
    profesadas, que ni siquiera se te ocurre la posibilidad de ponerlas
    en duda. Debido a tales creencias. Ves el mundo v te ves a ti mismo
    de una manera deformada. Estás tan profundamente "programado" y
    padeces tan intensamente la presión de la sociedad que te ves
    literalmente obligado a percibir el mundo de esa manera deformada. Y
    no hay solución, porque ni si quiera sospechas que tu percepción
    está deformada, que piensas de manera equivocada, que tus creencias
    son falsas.
  + La razón por la que eres infeliz es porque no dejas de pensar en lo
    que no tienes, en lugar de pensar más bien en lo que tienes en este
    momento.
  + La sociedad enseña a estar siempre insatisfecho, para dominarte y
    controlarte.
  + Lo que te hace feliz o desdichado no es el mundo ni las personas que
    te rodean, sino los pensamientos que albergas en tu mente.
...
* [[https://es.wikipedia.org/wiki/Antoine_de_Saint-Exup%C3%A9ry][Antoine de Saint-Exupéry (1900-1944)]]
  ...
  + Parece que la perfección se alcanza no cuando ya no hay nada que
    añadir, sino cuando ya no hay nada que quitar.
  ...
  + Todos los días, para el trabajador que comienza a construir el
    mundo, el mundo comienza.
...
* [[https://es.wikipedia.org/wiki/Antonio_Gala][Antonio Gala (1930-2023)]]
  ...
  + Nuestra sociedad ha llegado a un momento en que ya no adora al
    becerro de oro, sino al oro del becerro.

* [[https://es.wikipedia.org/wiki/Antonio_Gramsci][Antonio Gramsci (1891-1937)]]
  ...
  + La realidad está definida con palabras. Por lo tanto, el que
...
* [[https://es.wikipedia.org/wiki/Antonio_Machado][Antonio Machado (1875-1939)]]
  + A vosotros no os importe pensar lo que habéis leído ochenta veces y
    oído quinientas, porque no es lo mismo pensar que haber leído.
  + Algunos sentimientos perduran a través de los siglos, pero no por
    eso han de ser eternos. ¿Cuántos siglos durará todavía el
    sentimiento de la patria? ¿Y el sentimiento de la paternidad?
  ...
  + Ayudadme a comprender lo que os digo, y os lo explicaré más
    despacio.
  + Busca a tu prójimo no para que te confirme en tus juicios, sino para
    que los contradiga.
  + ¿Cabe una comunión cordial entre hombres, que nos permita cantar en
    coro, animados de un mismo sentir?
  ...
  + Dios no es el creador del mundo (según Martín), sino el creador de
    la nada.
  + El amor comienza a revelarse como un súbito incremento del caudal de
    la vida, sin que, en verdad, aparezca objeto concreto al cual
    tienda.
  + El corazón del poeta, tan rico en sonoridades, es casi un insulto a
    la afonía cordial de la masa.
  ...
  + El escepticismo que, lejos de ser, como muchos creen, un afán de
    negarlo todo es, por el contrario, el único medio de defender
    algunas cosas.
  + El movimiento no es nada esencial. La fuerza puede ser inmóvil (lo
    es en su estado de pureza); mas no por ello deja de ser
    activa.
  + El sentimiento ha de tener tanto de individual como de genérico;
    debe orientarse hacia valores universales, o que pretenden
    serlo.
  + El ser y el pensar (el pensar homogeneizador) no coinciden ni por
    casualidad.
  ...
  + Incierto es, lo porvenir. ¿Quién sabe lo que va a pasar? Pero
    incierto es también lo pretérito. ¿Quién sabe lo que ha pasado? De
    suerte que ni el porvenir está escrito en ninguna parte, ni el
    pasado tampoco.
  + Juzgarnos o corregirnos supone aplicar la medida ajena al paño
    propio.
  + La inseguridad, la incertidumbre, la desconfianza, son acaso
    nuestras únicas verdades. Hay que aferrarse a ellas.
  + La memoria es infiel: no sólo borra y confunde, sino que, a veces,
  ...
  + La política, señores, es una actividad importantísima. Yo no os
    ...
    cuneta del camino.
  + La República no es un fin, sino un medio para que España recobre su
    pulso y su fe en sí misma.
  ...
  + Nadie debe asustarse de lo que piensa, aunque su pensar aparezca en
    pugna con las leyes más elementales de la lógica. Porque todo ha de
    ser pensado por alguien, y el mayor desatino puede ser un punto de
    vista de lo real.
  + No es la belleza el gran incentivo del amor, sino la sed metafísica
    de lo esencialmente otro.
  + No hay lío político que no sea un trueque, una confusión de
    máscaras, un mal ensayo de comedia, en que nadie sabe su papel.
  ...
  + Sed incompresivos; yo os aconsejo la incomprensión, aunque sólo sea
    para destripar los chistes de los tontos.
  + Si es bueno vivir, todavía es mejor soñar, y lo mejor de todo,
    despertar.
  + "Sólo sé que no se nada" contenía la jactancia de un excesivo saber,
    puesto que olvidó añadir: y aun de esto mismo no estoy completamente
    seguro.
  + Todo lo que se ignora, se desprecia.
  + Todo necio confunde valor y precio.
  + Vivir es devorar tiempo, esperar; y por muy trascendente que quiera
  ...
  + Ya algunos pedagogos comienzan a comprender que los niños no deben
    ser educados como meros aprendices de hombre, que hay algo sagrado
    en la infancia para vivir plenamente por ella.
...
* [[https://es.wikipedia.org/wiki/Arist%C3%B3teles][Aristóteles (384-322 a.C.)]]
  ...
  + La excelencia moral es producto del hábito. Llegamos a ser justos
    practicando la justicia, moderados practicando la moderación,
  ...
  + La habilidad de exponer una idea es tan importante como la idea en
    sí misma.
  + La virtud consiste en un término medio.
...
* [[https://es.wikipedia.org/wiki/Arthur_Schopenhauer][Arthur Schopenhauer (1788-1860)]]
  ...
  + Cada uno toma los límites de su propio campo de visión por los
    límites del mundo.
  + Cada uno ve en el otro solo aquello que él mismo es, pues solo puede
    comprenderlo y entenderlo en la medida de su propia inteligencia.
  + Casi todas nuestras penas surgen de nuestras relaciones con los
    demás. No hay camino más equivocado hacia la felicidad que la
    mundanidad.
  + Cinco minutos después de nacer, decidirán tu nombre, nacionalidad,
    religión y secta, y pasarás el resto de tu vida defendiendo
    desesperadamente cosas que no elegiste.
  ...
  + El dolor y el aburrimiento son los dos mayores enemigos de la
    felicidad humana. Al respecto cabe observar que cuanto más
    conseguimos sustraernos a uno de ellos, más nos acercamos al otro, y
    viceversa; por lo que nuestra vida representa en el fondo un
    movimiento de oscilación más o menos rápido entre ambos.
  ...
  + En ausencia de grandes sufrimientos, los más pequeños inconvenientes
    nos torturan.
  + En consecuencia el presente siempre resulta insatisfactorio, pero el
    futuro es incierto y el pasado irrevocable.
  + En general, las nueve décimas partes de nuestra felicidad se
    fundamentan en la salud.
  ...
  + La ataraxia es el estado perfecto del sabio, al que le da lo mismo
    morir que vivir, porque ha comprendido que él no es tan importante
    como se creía, que sólo es una piececita del todo que va mucho más
    allá de lo que le envuelve.
  + La felicidad pertenece a quienes se bastan a sí mismos. Pues todas
    las fuentes externas de felicidad y placer son, por su propia
    naturaleza, sumamente inciertas, precarias, efímeras y sujetas al
    azar.
  ...
  + La soledad concede al hombre dotado de grandes cualidades
    ...
    los demás.
  + La soledad es el destino de todos los espíritus superiores.
  + La verdad no disfruta más que de una breve fiesta de victoria entre
    dos largos períodos: durante el primero es condenada por paradójica,
    y durante el segundo, menospreciada por banal.
  + La vida oscila, como un péndulo, de derecha a izquierda, del
    sufrimiento al aburrimiento.
  + La vida y los sueños son hojas de un mismo libro. Leerlas en orden
    es lo que llamamos la vida real. Pero cuando el tiempo habitual de
    lectura (el día) llega a su fin y llega el momento de descanso, a
    menudo seguimos hojeándolo ociosamente y abrimos una página aquí y
    otra allá, sin orden ni conexión; a veces una página ya leída, otras
    una todavía desconocida, pero siempre del mismo libro.
  ...
  + Lo que otorga al paisaje esa paz serena es el ser un mero reflejo de
    la paz del sujeto.
  ...
  + No es lo que las cosas son realmente, sino lo que son para nosotros
    según nuestra interpretación lo que nos hace felices o infelices.
  ...
  + Nueve décimas partes de nuestra felicidad se basan exclusivamente en
    nuestra salud.
  + Pocas veces pensamos en lo que tenemos; pero siempre en lo que nos
    falta.
  + Querer es esencialmente sufrir, y como vivir es querer, toda vida es
    por esencia dolor.
  + Renunciamos a tres cuartas partes de nosotros mismos para ser como
    los demás.
  + Solo cuando se está solo, se está plenamente consigo mismo; quien,
    por tanto, no ama la soledad, tampoco ama la libertad, pues
    únicamente en la soledad se es libre.
  + Sufrimos al no obtener lo que deseamos y, si lo obtenemos, nos
    ...
    y el tedio.
  + Toda queja es, en el fondo, una acusación contra uno mismo.
  + Toda verdad pasa por tres etapas. Primero, es ridiculizada. En
    segundo lugar, se le opone violentamente. En tercer lugar, se acepta
  ...
  + Todos buscan el porqué en vez de considerar el qué; aspiran a lo
    ...
    resuelve.
  + Todos los placeres son quiméricos. Conviene una total moderación
    porque precisamente el afán y lucha por la felicidad, el lujo y el
    placer es lo que provoca las grandes desgracias. Ser feliz no es
    difícil sino totalmente imposible.
  + Un hombre solo puede ser él mismo mientras esté solo; si no ama la
    soledad, no ama la libertad, pues solo cuando se está solo se es
    libre.
...
* [[https://es.wikipedia.org/wiki/Arturo_Graf][Arturo Graf (1948-1913)]]
  ...
  + El que en un arte ha llegado a maestro puede prescindir de las
    reglas.
  + Hay quienes, obsesionados con la prudencia , por querer evitar hasta
    el más mínimo error, convierten toda su vida en un único error.
...
* [[https://es.wikipedia.org/wiki/Auguste_Comte][Auguste Comte (1798-1857)]]
...
* [[https://es.wikipedia.org/wiki/Avicena][Avicena (980-1037)]]
  + La imaginación es la mitad de la enfermedad, la tranquilidad es la
    mitad del remedio y la paciencia es el comienzo de la cura.

* [[https://es.wikipedia.org/wiki/Azor%C3%ADn][Azorín (1873-1967)]]
  + Si lo pensamos, veremos que muchos de los disgustos que nos
    sobrevienen lo son por palabras innecesarias.
...
* [[https://es.wikipedia.org/wiki/Baltasar_Graci%C3%A1n][Baltasar Gracián (1601-1658)]]
  ...
  + Has de hablar como en testamento, que a menos palabras, menos
    pleitos.
  + Lo bueno, si breve, dos veces bueno; lo malo, si poco, no tan malo.
  + Más daña el decaimiento del ánimo que el del cuerpo.
  + No hay peor sordo que el que no puede oír; pero hay otro peor, aquél
    que por una oreja le entra y por otra se le va.
...
* [[https://es.wikipedia.org/wiki/Baruch_Spinoza][Baruch Spinoza (1632-1677)]]
  ...
  + La paz no es la ausencia de guerra, es una virtud, un estado de
    ánimo, una disposición a la benevolencia, a la confianza y a la
    justicia.
  ...
  + Los hombres se equivocan al creerse libres; y esta opinión consiste
    solo en que son conscientes de sus acciones e ignorantes de las
  ...
  + No hay esperanza que no esté acompañada de miedo, ni miedo que no
    esté acompañado de esperanza.
  ...
  + Si quieres que la vida te sonría, apórtale primero tu buen humor.
...
* [[https://es.wikipedia.org/wiki/Benjamin_Franklin][Benjamin Franklin (1706-1790)]]
  ...
  + La ociosidad, como el moho, desgasta mucho más rápidamente que el
    trabajo.
  + La oxidación por falta de uso gasta mucho más las herramientas que
    el propio trabajo.
  ...
  + Si el hombre alcanzara la mitad de los deseos que tiene, redoblaría
    sus inquietudes.
...
* [[https://es.wikipedia.org/wiki/Bertrand_Russell][Bertrand Russell (1872-1970)]]
  ...
  + La causa fundamental del problema es que, en el mundo moderno, los
    estúpidos están ciegamente seguros de sí mismos, mientras que los
...
* [[https://es.wikipedia.org/wiki/Blaise_Pascal][Blaise Pascal (1623-1662)]]
  ...
  + La costumbre es una segunda naturaleza que destruye la
    primera. Pero ¿qué es naturaleza? ¿Por qué la costumbre no es
    natural? Tengo mucho miedo de que esta naturaleza no sea a su vez
    sino una primera costumbre, al igual que la costumbre es una segunda
    naturaleza.
  ...
  + La vida humana no es más que una ilusión perpetua; no hacemos sino
    engañarnos y adularnos mutuamente.
  ...
  + Toda la desdicha de los hombres proviene de una sola cosa: no saber
...
* [[https://es.wikipedia.org/wiki/Bruce_Lee][Bruce Lee (1940-1973)]]
  ...
  + No te establezcas en una forma, adáptala y construye la tuya propia,
    y déjala crecer, sé como el agua. Vacía tu mente, se amorfo,
    moldeable, como el agua. Si pones agua en una taza se convierte en
    la taza. Si pones agua en una botella se convierte en la botella. Si
    la pones en una tetera se convierte en la tetera. El agua puede
    fluir o puede chocar. Sé agua, amigo mío.

* [[https://es.wikipedia.org/wiki/Buda_Gautama][Buda Gautama (c. 563-483 a.C.)]]
  + Cada mañana nacemos de nuevo. Lo que hacemos hoy es lo que más
    importa.
  + Duda de todo. Encuentra tu propia luz.
  + En lo que pensamos, nos convertimos.
  + La mente precede a las cosas, las domina, las crea. Si alguien habla
    o actúa con la mente impura, el sufrimiento le sigue como la rueda
    del carro sigue la huella del buey.
  ...
  + No creáis nada por el simple hecho de que muchos lo crean o finjan
    que lo creen; creedlo después de someterlo al dictamen de la razón y
...
* [[https://bit.ly/3o1l5tc][C.S. Lewis (1898-1963)]]
...
* [[https://es.wikipedia.org/wiki/Carl_Gustav_Jung][Carl Gustav Jung (1875-1961)]]
  ...
  + De niño me sentía solo, y todavía me siento así, porque sé cosas e
    insinúo cosas que otros parecen no conocer y no quieren saberlas. La
    soledad consiste en no poder comunicar las cosas o callar ciertos
    puntos de vista que otros encuentran inadmisibles.
  + El zapato que va bien a una persona es estrecho para otra: no hay
    receta de la vida que vaya bien para todos.
  ...
  + Las personas podrían aprender de sus errores si no estuvieran tan
    ocupadas negándolos.
  + Nadie aprende a vivir de verdad fantaseando con la perfección, sino
    mirando de frente su propia realidad.
  ...
  + Todo aquello que nos desagrada de los demás puede conducirnos a un
...
* [[https://es.wikipedia.org/wiki/Cat%C3%B3n_el_Joven][Catón el Joven (-95, -46)]]
  + La primera virtud es frenar la lengua, y es casi un dios quien
    teniendo razón sabe callarse.
  + Nunca está nadie más activo que cuando no hace nada, nunca está
    menos solo que cuando está consigo mismo.

* [[https://en.wikipedia.org/wiki/Cesare_Pavese][Cesare Pavese (1908-1950)]]
  + La única alegría en el mundo es comenzar. Es hermoso vivir porque
    vivir es comenzar, siempre, a cada instante. Cuando falta esa
    sensación uno quisiera morir.
...
* [[https://en.wikipedia.org/wiki/Charles_Baudelaire][Charles Baudelaire (1821-1867)]]
  + Hay personas que sólo se divierten en manada. El verdadero héroe se
    divierte solo.
  + La inspiración consiste en trabajar todos los días.
  + Me parece que siempre estaría bien donde no estoy.
...
* [[https://es.wikipedia.org/wiki/Charles_Perrault][Charles Perrault (1628-1703)]]
  + Cosa por demás sabida es que el esperar no agrada, pero el que más
    se apresura no es el que más trecho avanza, que para hacer ciertas
...
* [[https://es.wikipedia.org/wiki/Zhuangzi][Chuang Tse (o Zhuangzi) (siglo IV a. C.)]]
  + En otro tiempo, Zhuang Zhou soñó que era una mariposa que
    revoloteaba feliz, ignorante de ser Zhou. De pronto despertó,
    aturdido, y era de nuevo Zhou. Pero ya no supo si era Zhou quien
    había soñado que era una mariposa, o una mariposa que ahora soñaba
    que era Zhou. Entre Zhou y la mariposa ha de haber por fuerza una
    distinción: a esto llamamos la transformación de las cosas.
  ...
  + Los hombres conocen la utilidad de lo útil, pero no conocen la
...
* [[https://es.wikipedia.org/wiki/Claude_Monet][Claude Monet (1840-1926)]]
...
* [[https://es.wikipedia.org/wiki/Cle%C3%B3bulo_de_Lindos][Cleóbulo de Lindos (-630, -560)]]
...
* [[https://es.wikipedia.org/wiki/Cicer%C3%B3n][Cicerón (106-43 a.C.)]]
...
* [[https://es.wikipedia.org/wiki/Confucio][Confucio (551-479 a.C.)]]
  ...
  + El verdadero conocimiento es conocer el alcance de la propia
    ignorancia.
  ...
  + ¿Quieres que te enseñe lo que es el conocimiento? Considerar que
    sabes lo que sabes y que no sabes lo que no sabes: en eso consiste
    el conocimiento.
...
* [[https://es.wikipedia.org/wiki/Konstant%C3%ADnos_Kav%C3%A1fis][Konstantínos Kaváfis (1863-1933)]]
...
* [[https://es.wikipedia.org/wiki/Daniel_Goleman][Daniel Goleman (1946-)]]
  + En un mundo tan cambiante encontramos que la flexibilidad, la
    posibilidad de adaptarse al cambio es más importante que la
    experiencia.
  + La facilidad con que una sociedad desprecia, y hasta sepulta, las
    visiones discrepantes depende evidentemente del conjunto de lagunas
    compartidas por sus ciudadanos. No nos damos cuenta de lo que nos
    desagrada ver y tampoco nos damos cuenta de que no nos damos cuenta.
...
* [[https://es.wikipedia.org/wiki/Denis_Diderot][Denis Diderot (1713-1784)]]
...
* [[https://es.wikipedia.org/wiki/Eduardo_Galeano][Eduardo Galeano (1940-2015)]]
  + Al fin y al cabo, somos lo que hacemos para cambiar lo que somos.
  + El automóvil, el televisor, el vídeo, la computadora personal, el
    teléfono celular y demás contraseñas de la felicidad, máquinas
    nacidas para «ganar tiempo» o para «pasar el tiempo», se apoderan
    del tiempo.
  ...
  + Estos son tiempos de uniformidad obligatoria en todo. Nunca el mundo
    ha sido tan desigual en brindar oportunidades y tan parejo en los
    hábitos que impone.
  ...
  + Me gusta la gente sentipensante, que no separa la razón del
    corazón. Que siente y piensa a la vez. Sin divorciar la cabeza del
    cuerpo, ni la emoción de la razón.
...
* [[https://es.wikipedia.org/wiki/Elbert_Hubbard][Elbert Hubbard (1856-1915)]]
  + Aquel que no entiende tus silencios, lo más seguro es que tampoco
...
* [[https://es.wikipedia.org/wiki/Emil_Cioran][Emil Cioran (1911-1995)]]
  + A medida que los años pasan, decrece el número de seres con quienes
    puede uno entenderse.
  ...
  + Estamos solos no solo cuando estamos solos, sino también cuando
    estamos con otros.
  + No juzgues a nadie sin antes haberte puesto en su lugar.
  + Nosotros no padecemos por la falta de sentido, sino por la
    repetición vacía de los instantes.
...
* [[https://es.wikipedia.org/wiki/Emily_Dickinson][Emily Dickinson (1830-1886)]]
  ...
  + La esperanza es esa cosa con plumas que se posa en el alma y canta
    sin parar.
  + Puedes mantenerte joven mientras aprendas.

* [[https://es.wikipedia.org/wiki/Epicteto][Epicteto (55, 135)]]
  + Acuérdate de que debes comportarte en la vida como en un
    banquete. ¿Llega ante ti algo de lo que se reparte? Extiende la mano
    y toma tu parte con mesura. ¿Pasa de largo? No lo retengas. ¿Aún no
    ha llegado a ti? No envíes de antemano tu deseo hacia él, sino
    espera pacientemente a que llegue a tu lado.
  ...
  + Debemos hacer lo mejor con las cosas que están en nuestro poder, y
    tomar el resto como las presenta la naturaleza.
  ...
  + En cada cosa que emprendas, detente y pregúntate: ‘¿Qué me exigirá
    esto?’ Y si no estás dispuesto a soportarlo, no lo hagas.
  ...
  + No son las cosas las que perturban a los hombres, sino sus juicios
    sobre las cosas.
  + No exijas que las cosas sucedan tal como lo deseas. Procura
    desearlas tal como suceden y todo ocurrirá según tus deseos.
  ...
  + Si deseas ser mejor muéstrate incapaz o incompetente en materias que
    no son de tu incumbencia.
  + Si deseas ser sabio, prepárate desde ahora a ser ridiculizado, a ser
    odiado, a ser objeto de burlas. Pero si perseveras, los mismos que
    hoy te ofenden, acabarán por admirarte.
...
* [[https://es.wikipedia.org/wiki/Epicuro][Epicuro (-341, -271)]]
  ...
  + En una disputa filosófica, el que es derrotado gana más, porque es
    el que más aprende.
  + La felicidad es el principal objetivo del hombre en la
    vida. Tranquilidad y racionalidad son las piedras angulares de la
    felicidad.
  + La autosuficiencia es la mayor de todas las riquezas.
  + Llegará un momento en que creas que todo ha terminado. Ese será el
    principio.
  + Las cosas que realmente necesitas son pocas y fáciles de conseguir;
    pero las cosas que imaginas que necesitas son infinitas y nunca
    estarás satisfecho.
  + Los beneficios de otras actividades llegan a aquellos que han
    llegado al final de un camino difícil, pero en el estudio de la
    filosofía el placer va a la par del conocimiento creciente; porque
    el placer no sigue al aprendizaje; más bien, el aprendizaje y el
    placer avanzan uno al lado del otro.
...
* [[https://es.wikipedia.org/wiki/Erich_Fromm][Erich Fromm (1900-1980)]]
  ...
  + Estamos produciendo seres humanos enfermos para tener una economía
    sana.
  + La creatividad requiere tener el valor de desprenderse de las
    certezas.
  + La historia humana comenzó con un acto de desobediencia y es muy
    probable que termine con un acto de obediencia.
  + La tarea psíquica que una persona puede y debe establecer por sí
    misma no es sentirse segura, sino ser capaz de tolerar la
    inseguridad.
...
* [[https://es.wikipedia.org/wiki/Ernst_Bloch][Ernst Bloch (1885-1977)]]
  + La razón no puede florecer sin esperanza ni la esperanza puede
    hablar sin la razón.
...
* [[https://es.wikipedia.org/wiki/Esquilo][Esquilo de Eleusis (-525, -456)]]
  + La verdad es la primera víctima de la guerra.
  + Las palabras son una medicina para el alma que sufre.
  + Las personas mayores se hallan siempre a tiempo de aprender.
...
* [[https://es.wikipedia.org/wiki/Eur%C3%ADpides][Eurípides (-480, -406)]]
...
* [[https://es.wikipedia.org/wiki/Fi%C3%B3dor_Dostoyevski][Fiódor Dostoyevski (1821-1881)]]
  ...
  + Nuestros tiempos son tiempos de mediocridad, de falta de
    ...
    hecho.
  + Soy enemigo de los lugares llenos de gente, de la fanfarronería de
    dinero y de linaje, de la pretensión, de la gente consumidora, de
    las relaciones fugaces y de las reuniones llenas de hipocresía y
    mentiras.
...
* [[https://es.wikipedia.org/wiki/Francisco_de_Quevedo][Francisco de Quevedo (1589-1654)]]
  ...
  + No es dichoso aquél a quien la fortuna no puede dar más, sino aquel
    a quien no puede quitar nada.
...
* [[https://es.wikipedia.org/wiki/Fran%C3%A7ois_de_La_Rochefoucauld][François de La Rochefoucauld (1613-1680)]]
  + Conocer las cosas que lo hacen a uno desgraciado, ya es una especie
    de felicidad.
  ...
  + Estamos tan acostumbrados a disfrazarnos para los demás, que al
    final nos disfrazamos para nosotros mismos.
  + La felicidad reside en los gustos y no en las cosas; somos felices
    cuando tenemos lo que nos gusta y no cuando tenemos lo que los demás
    encuentran agradable.
  ...
  + Nuestras virtudes no son, las más de las veces, sino vicios
    disfrazados.
...
* [[https://es.wikipedia.org/wiki/Luis_de_Le%C3%B3n][Fray Luis de León (1527-1591)]]
  + ¡Qué descansada vida                       \\
...
* [[https://es.wikipedia.org/wiki/Friedrich_Nietzsche][Friedrich Nietzsche (1844-1900)]]
  ...
  + Contra el positivismo, que se detiene ante el fenómeno diciendo
    «solo hay hechos», yo diría: no, precisamente hechos no hay, solo
    interpretaciones.
  + ¿Cuál es el sello de la libertad conquistada? No avergonzarse ya de
    uno mismo.
  ...
  + El arte bello no es la representación de una cosa bella, sino la
    bella representación de una cosa.
  + El conocimiento mata el obrar, para obrar es preciso hallarse
    envuelto por el velo de la ilusión.
  + El espíritu libre no tiene convicciones; solo tiene
    perspectivas. Toda convicción es una prisión de la que el
    pensamiento debe liberarse constantemente.
  + El olvido no es un simple peso muerto, como creen los superficiales:
    es un poder activo y genuinamente positivo. Sin olvido no podría
    haber felicidad, jovialidad, esperanza, orgullo, ni presente.
  ...
  + Hay que apartar de nosotros el mal gusto de querer coincidir con
    muchos.
  + La estimación del valor de la verdad debe ser puesta en cuestión por
    una vez: hagamos pues de ello, a modo de ensayo, nuestro problema.
  ...
  + La sencillez y naturalidad son el supremo y último fin de la
    cultura.
  + La serpiente que no puede mudar de piel perece. Lo mismo les ocurre
    a los espíritus a quienes se impide cambiar de opiniones: dejan de
    ser espíritu.
  + La ventaja de tener mala memoria es que se goza muchas veces con las
    mismas cosas.
  + La vida es cien veces más corta de lo que sería necesario para que
    nos aburramos en ella.
  + Las convicciones son enemigas de la verdad más peligrosas que las
    mentiras.
  + Las verdades son ilusiones de las que se ha olvidado que lo son;
    ...
    que han perdido su troquelado y que no son consideradas ahora como
    monedas, sino como metal.
  + Llega a ser quien eres.
  + Lo que distingue a las cabezas verdaderamente originales no es que
    sean las primeras en ver algo nuevo, sino el ver como nuevo lo que
    es viejo, conocido desde hace mucho tiempo, visto y pasado por alto
    por todo el mundo.
  + Lo que es grande en el hombre es que es un puente y no una meta: lo
    que puede amarse en el hombre es que es un tránsito y un ocaso.
  + Lo que mucho ocupa termina por preocupar.
  + Lo que no nos mata nos hace más fuertes.
  + Los hombres activos ruedan, como rueda una piedra, conforme a la
    estupidez de la mecánica.
  + Madurez del hombre: eso significa haber vuelto a encontrar la
    seriedad que, de niño, se tenía al jugar.
  + Mi fórmula para expresar la grandeza del hombre es el /amor fati/: el
    no querer que nada sea distinto, ni hacia adelante ni hacia atrás,
  ...
  + Mi soledad no depende de la presencia o ausencia de las personas; al
    ...
    compañía de verdad.
  + Nadie puede construirte el puente sobre el que precisamente tú debes
    cruzar el río de la vida; nadie salvo tú solo. Hay, ciertamente,
    innumerables senderos y puentes y semidioses que quisieran llevarte
    al otro lado; pero solo al precio de ti mismo: te empeñarías y te
    perderías. Hay en el mundo un único camino por el que nadie puede
    caminar excepto tú. ¿Adónde lleva? No preguntes, camínalo.
  + No hay hechos, sino interpretaciones.
  + ¡Qué poco se necesita para la felicidad! El sonido de una gaita. —
    Sin música, la vida sería un error. El alemán se imagina a Dios
    cantando canciones.
  + ¿Quién de vosotros puede reír y estar al mismo tiempo elevado? Quien
    sube a las montañas más altas, ése se ríe de todas las tragedias
    ficticias y verdaderas.
  + Quien lucha con monstruos debe procurar que, al hacerlo, no se
    convierta él mismo en un monstruo. Y si miras largo tiempo a un
    abismo, el abismo mira también dentro de ti.
  ...
  + Y eso a lo que habéis dado el nombre de mundo, eso debe ser creado
    primero por vosotros: ¡vuestra razón, vuestra imagen, vuestra
    voluntad, vuestro amor deben devenir ese mundo!
...
* [[https://es.wikipedia.org/wiki/G._K._Chesterton][G.K. Chesterton (1874-1936)]]
  + El loco no es el hombre que ha perdido la razón. El loco es el
    hombre que lo ha perdido todo, excepto la razón.
...
* [[https://es.wikipedia.org/wiki/Gabriela_Mistral][Gabriela Mistral (1889-1957)]]
  + Tengo un día. Si lo sé aprovechar, tengo un tesoro.

* [[https://es.wikipedia.org/wiki/Galileo_Galilei][Galileo Galilei (1564-1642)]]
...
* [[https://es.wikipedia.org/wiki/Georg_Wilhelm_Friedrich_Hegel][Friedrich Hegel (1770-1831)]]
...
* [[https://es.wikipedia.org/wiki/George_Berkeley][George Berkeley (1684-1753)]]
  + Pocos hombres piensan, pero todos tienen opiniones.
  + Ser es ser percibido o percibir.

* [[https://bit.ly/3oRRBiL][George Bernard Shaw (1856-1950)]]
  ...
  + La vida no consiste en encontrarte a ti mismo. La vida consiste en
    crearte a ti mismo.
...
* [[https://bit.ly/31dDTvO][George Lakoff (1941)]]
...
* [[https://es.wikipedia.org/wiki/George_Sand][George Sand (1804-1876)]]
  + La simplicidad es lo más difícil de conseguir en este mundo, es el
    último límite de la experiencia y el último esfuerzo del genio.

* [[https://es.wikipedia.org/wiki/George_Santayana][George Santayana (1863-1952)]]
  + Quienes no pueden recordar el pasado están condenados a repetirlo.

* [[https://es.wikipedia.org/wiki/George_Steiner][George Steiner (1929-2020)]]
  + Una relación humana se puede destrozar con una palabra
    incorrecta. Una sola palabra puede abrir una inmensa oscuridad. El
    lenguaje es el instrumento de la gracia y de la destrucción del ser
    humano. El diablo debe ser un gran lingüista.
...
* [[https://es.wikipedia.org/wiki/Georges_Duhamel][Georges Duhamel (1884-1996)]]
  + Si quieres hallar en cualquier lado amistad, dulzura y poesía,
    llévalas contigo.

* [[https://es.wikipedia.org/wiki/Gibran_Jalil_Gibran][Khalil Gibran (1883-1931)]]
  + Cuando estéis alegres mirad en el fondo de vuestros corazones y
    hallaréis que lo mismo que os da hoy alegría fue aquello que os
    llenó ayer de tristeza.
  + Del hablador he aprendido a callar; del intolerante, a ser
    indulgente, y del malévolo a tratar a los demás con amabilidad. Y
    por curioso que parezca, no siento ninguna gratitud hacia esos
    maestros.
  + El ayer no es más que el recuerdo de hoy, y el mañana es el sueño de
    hoy.
  + El olvido es una forma de libertad.
  + El optimista ve la rosa y no sus espinas; el pesimista clava la
    mirada en las espinas, ajeno a la rosa.
  + En cada invierno del corazón hay una trémula primavera, y tras el
    velo de cada noche se esconde un sonriente amanecer.
  + En el corazón de todos los inviernos vive una primavera palpitante,
    y detrás de cada noche, viene una aurora sonriente.
  + En el rocío de las pequeñas cosas, el corazón encuentra su mañana y
    toma su frescura.
  + Hay una trémula primavera en cada invierno del corazón, y un
    sonriente amanecer se esconde tras el velo de cada noche.
  + La tortuga puede hablar más del camino que la liebre.
  + Me consideran loco porque no vendo mis días por oro. Y yo
    los considero locos porque creen que mis días tienen precio.
  + No se puede llegar al alba sino por el sendero de la noche.
  + Por muy larga que sea la tormenta, el sol siempre vuelve a brillar
    entre las nubes.
  + Tu vida está determinada no tanto por lo que la vida te trae sino
    por la actitud que le pones a la vida; no tanto por lo que te sucede
    sino por la forma en que tu mente mira lo que sucede.

* [[https://es.wikipedia.org/wiki/Giacomo_Leopardi][Giacomo Leopardi (1798-1837)]]
...
* [[https://es.wikipedia.org/wiki/Graham_Greene][Graham Greene (1904-1991)]]
...
* [[https://es.wikipedia.org/wiki/Groucho_Marx][Groucho Marx (1890-1977)]]
  ...
  + Me gustan mis errores, no quiero renunciar a la deliciosa libertad
    de equivocarme.
  + Todavía no sé qué me vas a preguntar, pero me opongo.

* [[https://es.wikipedia.org/wiki/Guillermo_de_Ockham][Guillermo de Ockham (1287-1347)]]
...
* [[https://es.wikipedia.org/wiki/Gustave_Flaubert][Gustave Flaubert (1821-1880)]]
  ...
  + Lo mejor de la vida se pasa diciendo "es demasiado pronto", y
    después es "demasiado tarde".
  + Ser estúpido, egoísta y estar bien de salud, he aquí las tres
    condiciones que se requieren para ser feliz. Pero si os falta la
    primera, estáis perdidos.
...
* [[https://es.wikipedia.org/wiki/Hannah_Arendt][Hannah Arendt (1906-1975)]]
  ...
  + Mentir constantemente no tiene como objetivo hacer que la gente crea
    una mentira, sino garantizar que nadie crea en nada. Un pueblo que
    ya no distingue entre la verdad y la mentira no puede distinguir
    entre el bien y el mal: un pueblo privado del poder de pensar.
...
* [[https://es.wikipedia.org/wiki/Hans-Georg_Gadamer][Hans-Georg Gadamer (1900-2002)]]
  + El ser, en cuanto puede ser comprendido, es lenguaje.
...
* [[https://es.wikipedia.org/wiki/Henri_Bergson][Henri Bergson (1859-1941)]]
  + El ojo ve sólo lo que la mente está preparada para comprender.
  + El olvido es una función tan esencial como la memoria, pues consiste
    en descartar todo lo que no tiene interés actual para la acción.
  + En la práctica, no percibimos sino el pasado; el presente puro es el
    inaprensible avance del pasado devorando el porvenir.
  + Es preciso que cambie a cada momento, porque dejar de transformarse
    es dejar de vivir.
  + Existir consiste en cambiar, cambiar en madurar, madurar en crearse
    a sí mismo indefinidamente.
  + La duración es el progreso continuo del pasado que roe el porvenir y
    que se hincha al avanzar.
  ...
  + Para un ser consciente, existir consiste en cambiar; cambiar, en
    madurar; madurar, en crearse indefinidamente a sí mismo.
  + Percibir es, sobre todo, recordar.
...
* [[https://es.wikipedia.org/wiki/Henry_David_Thoreau][Henry David Thoreau (1817-1862)]]
  ...
  + El ser humano se ha vuelto la herramienta de sus herramientas.
  + El verdadero precio de cualquier cosa que hagas es la cantidad de
    tiempo que cambias por ella.
  ...
  + La felicidad es como una mariposa; cuanto más la persigas, más te
    eludirá, pero si prestas atención a otras cosas, vendrá y se sentará
    suavemente en tu hombro.
  + Las cosas no cambian; nosotros cambiamos.
  + Lo que importa no es lo que miras, sino lo que alcanzas a ver.
  ...
  + Si alguien no marcha al mismo paso que sus compañeros, tal vez es
    que escucha un tambor distinto.
  + Solo amanece el día para el cual estamos despiertos.
  + Yo diría que todos los acontecimientos memorables ocurren por la
    mañana y en una atmósfera matinal.

* [[https://es.wikipedia.org/wiki/Henry_Ford][Henry Ford (1863-1947)]]
  + Cualquier persona que deja de aprender es viejo, ya sea a los veinte
    o a los ochenta. Cualquiera que sigue aprendiendo se mantiene
...
* [[https://es.wikipedia.org/wiki/Herbert_Marcuse][Herbert Marcuse (1898-1979)]]
  + La libre elección de amos no suprime ni a los amos ni a los
    esclavos.

* [[https://es.wikipedia.org/wiki/Herbert_Alexander_Simon][Herbert Simon (1916-2001)]]
  + El exceso de información genera escasez de atención.
...
* [[https://es.wikipedia.org/wiki/Hermann_Hesse][Hermann Hesse (1877-1962)]]
  ...
  + Aprende a tomar en serio solo lo que es digno de ello, y ríete de
    todo lo demás.
  + Aquellos que no saben gobernarse a sí mismos están constantemente
    buscando un líder al que adorar.
  + Cualquier cosa parece un poco más pequeña cuando se ha dicho en voz
    alta.
  ...
  + La vida de cada hombre es un camino hacia sí mismo, el intento de un
    camino, el esbozo de un sendero.
  + Las cosas que vemos son las mismas cosas que llevamos en
    nosotros. No hay más realidad que la que tenemos dentro. Por eso la
    mayoría de los seres humanos viven tan irrealmente; porque cree que
    las imágenes exteriores son la realidad.
  ...
  + ¿Qué puedo decirte que te pueda ser útil, excepto que tal vez estás
    buscando algo con tanta insistencia que consigues no encontrar nada?
  + Si quieres ser fuerte es importante aprender a estar solo.
  + Todas las cosas poseen una faceta bella, aun las cosas feas o
    desprovistas de interés; sólo hace falta saber mirar.
  + ¿Y de qué sirve hablar, si ya sabes que los demás no sienten lo que
    sientes?

* [[https://es.wikipedia.org/wiki/Her%C3%B3doto][Herodoto (-484,-425)]]
  + La prisa en todo negocio suele acarrear fracasos, de los que suelen
    nacer grandes daños. En cambio, en el esperar hay ventajas que,
    aunque no se vean de inmediato, el tiempo las descubre.
  + Es más fácil embaucar a una multitud que a un solo hombre.
  + Tu estado de ánimo es tu destino.

* [[https://es.wikipedia.org/wiki/Her%C3%A1clito][Heráclito de Éfeso (c. 535 – c. 475 a.C.)]]
  + Día a día, lo que eliges, lo que piensas y lo que haces es en lo que
    te conviertes.
  + El buen carácter no se forma en una semana o un mes. Se crea poco a
    poco, día a día. Se necesita un esfuerzo prolongado y paciente para
    desarrollar un buen carácter.
  + El camino hacia arriba y hacia abajo es uno solo y el mismo.
  + El carácter (modo de ser) del hombre es su daimon (el genio rector
    de su vida).
  ...
  + Lo contrapuesto concuerda, y de los discordantes se forma la más
    bella armonía.
  + Nadie se baña dos veces en el mismo río, pues nunca es el mismo río
    y nunca es el mismo hombre.
...
* [[https://es.wikipedia.org/wiki/Hip%C3%B3crates][Hipócrates (-460, -370)]]
...
* [[https://es.wikipedia.org/wiki/Horacio][Horacio (-65, -8)]]
...
* [[https://es.wikipedia.org/wiki/Immanuel_Kant][Immanuel Kant (1724-1804)]]
  ...
  + El hombre ha de estar ocupado de tal modo que, lleno del fin que
    tiene a la vista, casi no se sienta a sí mismo; su mejor descanso es
  ...
  + La razón humana tiene el peculiar destino... de verse agobiada por
    preguntas que no puede rechazar... pero que tampoco puede
    responder...
  ...
  + Reglas para la felicidad: algo que hacer, alguien a quien amar, algo
    que esperar.
  + Se comprende mucho mejor un mapa, cuando se le puede hacer por uno
    mismo. El mejor recurso para comprender, es producir.
...
* [[https://es.wikipedia.org/wiki/Isaac_Newton][Isaac Newton (1643-1727)]]
  + La verdad siempre se halla en la simplicidad y no en la
    multiplicidad y confusión de las cosas.
  + Lo que sabemos es una gota de agua; lo que ignoramos es el océano.
  + Los seres humanos construimos demasiados muros y no suficientes
    puentes.
...
* [[https://bit.ly/2RHtRyr][Italo Calvino (1923-1985)]]
...
* [[https://en.wikipedia.org/wiki/James_Russell_Lowell][James Russell Lowell (1819-1891)]]
  + Bienaventurados los que no tienen nada que decir, y que resisten la
    tentación de decirlo.
  + ¡Cuánta confianza nos inspira un libro viejo del cual el tiempo nos
    ha hecho ya la crítica!
  + En general, quienes no tienen nada que decir invierten el mayor
    tiempo posible en no decir nada.
  + Las desgracias más temidas son, de ordinario, las que no llegan
    jamás.

* [[https://es.wikipedia.org/wiki/Jane_Austen][Jane Austen (1775-1817)]]
  + Cada momento tiene sus placeres y sus esperanzas.
...
* [[https://es.wikipedia.org/wiki/Jean_Anouilh][Jean Anouilh (1910-1987)]]
  + Las preocupaciones acaban por comerse unas a otras, y al cabo de
    diez años, se da uno cuenta de que se sigue viviendo.

* [[https://en.wikipedia.org/wiki/Jean_Baudrillard][Jean Baudrillard (1929-2007)]]
  + Vivimos en un mundo donde cada vez hay más información y cada vez
    menos significado.
...
* [[https://es.wikipedia.org/wiki/Jean_de_La_Bruy%C3%A8re][Jean de La Bruyère (1645-1696)]]
  + En la sociedad, el hombre sensato es el primero que cede
    siempre. Por eso, los más sabios son dirigidos por los más necios y
    extravagantes.
  + Es una enorme desgracia no tener talento para hablar bien, ni la
    sabiduría necesaria para cerrar la boca.
  + La persona sabia a menudo evita la sociedad por miedo a aburrirse.
  + Los niños no tienen pasado ni futuro. Así disfrutan del presente,
    cosa que pocas veces nos sucede a nosotros.
...
* [[https://es.wikipedia.org/wiki/Jean-Paul_Sartre][Jean-Paul Sartre (1905-1980)]]
  ...
  + El hombre no es más que lo que se hace.
  + Existe mucha gente en el mundo que está en un infierno porque
    depende excesivamente del juicio de los demás.
  + Felicidad no es hacer lo que uno quiere sino querer lo que uno hace.
  + La nada es la presencia de una ausencia.
  + Lo importante no es lo que se hace de nosotros, sino lo que nosotros
    mismos hacemos con lo que se ha hecho de nosotros.
  + Lo que hace o deshace a un hombre no es lo que la gente piensa de
    él, sino lo que él piensa de sí mismo.
  + No importa lo que hicieron de nosotros, sino lo que hacemos con lo
    que hicieron de nosotros.
  + Si te sientes solo cuando estás solo, estás mal acompañado.
  + Somos nuestras elecciones.
  + Un hombre es siempre un narrador de historias; vive rodeado de sus
    historias y de las historias ajenas, ve todo lo que le sucede a
    través de ellas; y trata de vivir su vida como si la contara.
...
* [[https://es.wikipedia.org/wiki/Jiddu_Krishnamurti][Jiddu Krishnamurti (1895-1986)]]
  + La capacidad de observar sin evaluar es la forma más alta de
    inteligencia.
  + La educación no tiene fin. No es que leas un libro, pases un examen
    y termines con la educación. Toda la vida, desde el momento en que
    naces hasta el momento en que mueres, es un proceso de aprendizaje.
  + Muere a todo lo de ayer para que tu mente esté siempre fresca,
    siempre joven, inocente, llena de vigor y pasión.
...
* [[https://es.wikipedia.org/wiki/John_Steinbeck][John Steinbeck (1902-1968)]]
  ...
  + Las ideas son como los conejos. Usted obtiene un par, aprende a
    cuidarlos, y muy pronto tendrá una docena.
...
* [[https://es.wikipedia.org/wiki/Johann_Wolfgang_von_Goethe][Johann Wolfgang von Goethe (1749-1832)]]
  + Aquel que encuentra la paz en su hogar, ya sea rey o aldeano, es de
    todos los seres humanos el más feliz.
  ...
  + En el alma del ser humano hay una chispa que, si no recibe alimento
    ni es avivada, queda cubierta por las cenizas de las ocupaciones
    cotidianas y la indiferencia, a pesar de que tarda mucho en
    extinguirse o no lo hace casi nunca.
  ...
  + Feliz es el hombre que aprende temprano el amplio abismo existente
    entre sus deseos y sus facultades.
  + Hablar es una necesidad, escuchar es un arte.
  + Hay quien porque golpea la pared con un martillo, se cree que clava
    clavos.
  + He llegado a la conclusión aterradora de que yo soy el elemento
    decisivo en mi vida. Yo poseo el tremendo poder para hacer mi vida
    miserable o alegre. Para con otros y conmigo mismo, yo puedo ser una
    herramienta de tortura o un instrumento de inspiración. Es mi
    respuesta que decide si una crisis se escala o no. Son mis acciones
    que deciden si yo me ennoblezco o me degrado, y si humanizan o
    deshumanizan a los demás. Yo soy el poder en mi vida.
  + La actividad es lo que hace feliz al hombre.
  + La paloma protesta contra el aire, sin darse cuenta de que es lo
    único que le permite volar.
  ...
  + No hablaríamos tanto en sociedad si nos diéramos cuenta del poco
    caso que hacen los demás de lo que decimos.
...
* [[https://es.wikipedia.org/wiki/Jonathan_Swift][Jonathan Swift (1667-1745)]]
  ...
  + Tenemos bastante religión para odiarnos unos a otros, pero no la
    bastante para amarnos.
  + Todo el mundo quiere vivir mucho tiempo, pero nadie quiere ser
    viejo.
...
* [[https://es.wikipedia.org/wiki/Jorge_Luis_Borges][Jorge Luis Borges (1899-1986)]]
  ...
  + Quizá haya enemigos de mis opiniones, pero yo mismo, si espero un
    rato, puedo ser también enemigo de mis opiniones.
  + Si de algo soy rico es de perplejidades y no de certezas.
  + Siempre imaginé que el Paraíso sería algún tipo de biblioteca.
  + Uno no es lo que es por lo que escribe, sino por lo que ha leído.

* [[https://es.wikipedia.org/wiki/Jos%C3%A9_de_Letamendi][José de Letamendi (1828-1897)]]
...
* [[https://es.wikipedia.org/wiki/Jos%C3%A9_Luis_Sampedro][José Luis Sampedro (1917-2013)]]
  ...
  + Gobernar a base de miedo es eficacísimo. Si usted amenaza a la gente
    ...
    ha degollado.
  + Gobernar a base de miedo, es muy eficaz. El miedo hace que no se
    reaccione, el miedo hace que no se siga adelante. El miedo es mucho
    más fuerte casi, desgraciadamente que el altruismo, que el amor, que
    la bondad. El miedo nos lo están dando todos los días en los medios
    de comunicación.
  + La felicidad es el derecho a la pereza y el deber de la alegría.
...
* [[https://es.wikipedia.org/wiki/Jos%C3%A9_Ortega_y_Gasset][José Ortega y Gasset (1883-1955)]]
  + El pensamiento es la única cosa del Universo de la que no se puede
    negar su existencia: negar es pensar.
  + La máxima especialización equivale a la máxima incultura.
  + La perspectiva es uno de los componentes de la realidad. Lejos de
  ...
  + Nuestras convicciones más arraigadas, más indubitables, son las más
    ...
    nuestra prisión.
  + Para tener mucha imaginación hay que tener muy buena memoria.
  ...
  + Vivir es un proceso constante de decidir qué vamos a hacer.
  + Vivir es sentirse perdido... El que no acepta que está perdido, se
...
* [[https://es.wikipedia.org/wiki/Jos%C3%A9_Saramago][José Saramago (1922-2010)]]
  ...
  + Es con lo que es con lo que tenemos que vivir, no con lo que sería o
    podría haber sido.
  ...
  + Todo el mundo me dice que tengo que hacer ejercicio, que es bueno
    para mi salud. Pero nunca he oído a nadie decirle a un deportista:
    tienes que leer.
...
* [[https://es.wikipedia.org/wiki/Juli%C3%A1n_Mar%C3%ADas][Julián Marías (1914-2005)]]
...
* [[https://es.wikipedia.org/wiki/Karl_Jaspers][Karl Jaspers (1883-1969)]]
  + El hombre es el animal que hace preguntas.
  + El hombre llega a ser él mismo cuando en su acción ha decidido a
    dónde quiere ir. Todos nosotros necesitamos reconquistarnos
    constantemente de nuevo. En lugar de decidir, rodamos por la vida.
  ...
  + Filosofía quiere decir: ir de camino. Sus preguntas son más
    ...
    nueva pregunta.
  + Incluso quien la rechaza no puede evitar hacer filosofía. Pues al
    cuestionarla, ya está filosofando.

* [[https://es.wikipedia.org/wiki/Karl_Marx][Karl Marx (1818-1883)]]
  + El trabajador se convierte en una mercancía tanto más barata cuantas
    más mercancías crea. La desvalorización del mundo humano crece en
    razón directa a la valorización del mundo de las cosas.
  + La religión es el suspiro de la criatura oprimida, el ánimo de un
    mundo sin corazón, así como el espíritu de una situación carente de
  ...
  + No es la conciencia de los hombres la que determina su ser, sino,
    por el contrario, su ser social lo que determina su conciencia.
...
* [[https://es.wikipedia.org/wiki/Karl_Popper][Karl Popper (1902-1994)]]
...
* [[https://bit.ly/3dUHggj][Katherine Mansfield (1888-1923)]]
  + Haz que sea una regla de vida nunca arrepentirse y nunca mirar
    atrás. El arrepentimiento es un espantoso desperdicio de energía; no
    se puede construir sobre ella; solo es bueno para revolcarse.
  + ¿Qué es lo que más quiero hacer? Esto es lo que no debo dejar de
    preguntarme ante las dificultades.

* [[https://en.wikipedia.org/wiki/Konrad_Lorenz][Konrad Lorenz (1903-1989)]]
...
* [[https://es.wikipedia.org/wiki/Lao-Tse][Lao-Tse (siglo VI a.C.)]]
  + Con arcilla se fabrican las vasijas, pero en ellas lo útil es la
    nada de su oquedad.
  ...
  + Conténtate con lo que tienes; alégrate de cómo son las cosas. Cuando
    ...
    pertenecerá.
  + El árbol que apenas puedes abarcar con tus brazos, nació de un
    minúsculo brote; la torre de nueve pisos comenzó por un cesto de
    tierra; el camino de mil leguas empieza bajo tus pies.
  ...
  + El sabio produce sin poseer, actúa sin esperar recompensa, completa
    su obra sin reclamar crédito. Precisamente porque no reclama
    crédito, su mérito permanece con él eternamente.
  ...
  + El Tao que puede ser expresado con palabras no es el Tao eterno. El
    nombre que puede ser nombrado no es el nombre eterno.
  ...
  + La felicidad más grande no consiste en poseer lo que deseas, sino en
    desear lo que ya posees.
  + La mente tiende a la quietud, pero la ansiedad se le opone.
  + La suprema bondad es como el agua. El agua todo lo favorece y con
    nada compite.
  ...
  + Quien conoce a los demás, posee inteligencia. Quien se conoce a sí
    mismo, posee clarividencia.
  + Quien cree en sí mismo no tiene necesidad de convencer a los demás.
  + ¿Quién es capaz de aclarar lo turbio aquietándolo poco a poco?
    ¿Quién es capaz de dar vida a lo que está en reposo moviéndolo poco
    a poco?
  + Quien no es feliz con poco no lo será con mucho.
  + Quien sabe contentarse, siempre tiene bastante.
  ...
  + ¿Tienes la paciencia de esperar hasta que el lodo se asiente y el
    agua esté clara?
  + Todos los seres florecen, pero cada uno retorna a su raíz. Retornar
    a la raíz es hallar el reposo. Hallar el reposo es cumplir el
    destino
...
* [[https://es.wikipedia.org/wiki/Le%C3%B3n_Tolst%C3%B3i][León Tolstói (1828-1910)]]
  + Cuando te esfuerzas por no censurar a los demás, tu vida resulta
    mucho más fácil, pero muy poca gente lleva a cabo este pequeño
    esfuerzo.
  + El descanso, la naturaleza, los libros, la música... tal es mi idea
    de la felicidad.
  + El único conocimiento absoluto que puede alcanzar el hombre, es que
  ...
  + Los librepensadores son aquellos que están dispuestos a usar sus
    mentes sin prejuicios y sin temor a comprender cosas que chocan con
    sus propias costumbres, privilegios o creencias. Este estado mental
    no es común, pero es esencial para el pensamiento correcto.
  + Mi felicidad consiste en que sé apreciar lo que tengo y no deseo con
    exceso lo que no tengo.
  + Todos piensan en cambiar a la humanidad, pero nadie piensa en
...
* [[https://es.wikipedia.org/wiki/Leonardo_da_Vinci][Leonardo da Vinci (1452-1519)]]
  ...
  + Hay tres clases de personas: las que ven, las que ven cuando se les
    muestra, las que no ven.
...
* [[https://es.wikipedia.org/wiki/Lewis_Carroll][Lewis Carroll (1832-1898)]]
...
* [[https://es.wikipedia.org/wiki/Lin_Yutang][Lin Yutang (1895-1975)]]
  ...
  + Bromear es una de las cosas amenas de la vida, pero cuesta muchos
    años de aprendizaje.
  + El arte de vivir consiste en saber sacar placer de las cosas más
    sencillas: una taza de té, un libro viejo, una conversación con un
    amigo.
  + El hombre sabio no trabaja para vivir; vive para disfrutar, y
    trabaja solo lo necesario para seguir disfrutando.
  + El hombre superior ama su alma; el hombre inferior ama su propiedad.
  + El primer deber del hombre es ser un poco egoísta… en el buen
    sentido: cuidar de su alma.
  + El sentido del humor es la más divina de las cualidades humanas. Es
    la luz que disipa la solemnidad absurda del mundo.
  + Hay dos maneras de difundir la luz... ser la lámpara que la emite, o
    el espejo que la refleja.
  + La naturaleza no tiene prisa, y aun así todo se cumple.
  + La pereza es la madre de la filosofía. Solo cuando el hombre se
    sienta a descansar empieza a pensar en el sentido de la vida.
  + La sabiduría de la vida consiste en la eliminación de lo no
    ...
    cultura.
  + La verdadera felicidad consiste en no hacer nada en particular, en
    no tener que ir a ninguna parte, en no tener que ser nadie.
  + La vida es un regalo que se disfruta, no un problema que se
    resuelve.
  ...
  + Los libros no se miden por su número, sino por el placer y la
    sabiduría que dejan en el alma.
...
* [[https://es.wikipedia.org/wiki/Louis_Pasteur][Louis Pasteur (1822-1895)]]
...
* [[https://es.wikipedia.org/wiki/S%C3%A9neca][Lucio Anneo Séneca (4 a.C. – 65 d.C.)]]
  ...
  + Importa mucho más lo que tú piensas de ti mismo que lo que los otros
    opinen de ti.
  + La filosofía no consiste en palabras, sino en obras.
  ...
  + Nadie es más esclavo que aquel que se cree libre sin serlo, o aquel
    que busca en las riquezas el remedio para su pobreza de espíritu. El
    oro y la plata no nos hacen mejores; solo nos hacen más visibles.
  ...
  + No hay dicha en poseer algo valioso, a menos que tengas con quien
    compartirlo.
  + No es porque las cosas sean difíciles por lo que no nos atrevemos;
    es porque no nos atrevemos por lo que las cosas son difíciles.
  ...
  + Para Epicuro son dos los bienes de que está compuesta la suprema
    ...
    espíritu.
  + Para quien ignora a qué puerto se dirige, ningún viento le es
    favorable.
  ...
  + Quizás suceda lo peor, quizás no, hasta entonces, espera cosas
    mejores.
  + Se necesita toda la vida para aprender a vivir.
...
* [[https://es.wikipedia.org/wiki/Lucrecio][Lucrecio (-99, -55)]]
  + Los necios no aprecian ni admiran sino los pensamientos ocultos bajo
    el disfraz de palabras misteriosas.
  + Las gotas de lluvia hacen un agujero en la piedra, no por la
    violencia, sino por la constante caída.
  + Siempre nos parece que el mayor bien es el que nos falta; si
    lográramos alcanzarlo, suspiraríamos por otro bien con el mismo
    ardor.
...
* [[https://es.wikipedia.org/wiki/Ludwig_Wittgenstein][Ludwig Wittgenstein (1889-1951)]]
...
* [[https://es.wikipedia.org/wiki/Maestro_Eckhart][Maestro Eckhart (1260-1328)]]
...
* [[https://es.wikipedia.org/wiki/Mahatma_Gandhi][Mahatma Gandhi (1869-1948)]]
  ...
  + Lo más atroz de las cosas malas de la gente mala es el silencio de
    la gente buena.
  + Ojo por ojo sólo conseguirá que el mundo entero quede ciego.
...
* [[https://bit.ly/38WP93b][Marcel Proust (1871-1922)]]
  ...
  + El instinto dicta el deber y la inteligencia da pretextos para
    eludirlo.
  + El único paraíso verdadero es el paraíso perdido.
  + El único viaje verdadero, el único baño de juventud, no consistiría
    en ir hacia nuevos paisajes, sino en tener otros ojos, en ver el
    universo con los ojos de otro, de otros cien, en ver los cien
    universos que cada uno de ellos ve, que cada uno de ellos es.
  + Lo que llamamos la realidad es cierta relación entre las sensaciones
    que recibimos y los recuerdos que nos circundan simultáneamente.
...
* [[https://bit.ly/2LqGY3P][Marco Aurelio (121-180)]]
  ...
  + Al amanecer, cuando te dé pereza despertar, di para tus adentros:
    'Me levanto para hacer el trabajo de un hombre'. ¿Voy a seguir
    quejándome por tener que hacer aquello para lo que he nacido?
  ...
  + De las cosas que tienes, escoge las mejores y después medita cuán
    afanosamente las hubieras buscado si no las tuvieras.
  ...
  + El tiempo es un río y una corriente impetuosa de
    ...
    presenta otra, y ésta también va a ser arrastrada.
  ...
  + No pienses más en lo que te falta, sino en lo que tienes, y escoge
    de entre las cosas que tienes las más valiosas, y reflexiona cuánto
    las habrías deseado si no las tuvieras.
  + No te dejes arrastrar por las circunstancias externas; dedica tiempo
    a aprender lo que es bueno y deja de dispersarte.
...
* [[https://es.wikipedia.org/wiki/Mario_Benedetti][Mario Benedetti (1920-2009)]]
...
* [[https://es.wikipedia.org/wiki/Mark_Twain][Mark Twain (1835-1910)]]
  + Buenos amigos, buenos libros y tener una conciencia tranquila: esta
    es la vida ideal.
  + Cada vez que te encuentres del lado de la mayoría, es momento de
  ...
  + No es lo que no sabes lo que te mete en problemas, sino lo que sabes
    con certeza y resulta que no es así.
  ...
  + ¡Qué fácil es hacer que la gente crea una mentira, y qué difícil es
    deshacer ese trabajo de nuevo!
  + Todo lo que necesitas en esta vida es ignorancia y confianza, y
    entonces el éxito es seguro.
  + Un hombre con una idea nueva es un loco hasta que la idea triunfa.
  + Un pesimista es un optimista bien informado.

* [[https://es.wikipedia.org/wiki/Martin_Heidegger][Martin Heidegger (1889-1976)]]
  ...
  + No habitamos el tiempo: nosotros somos el tiempo que se sabe finito.
...
* [[https://es.wikipedia.org/wiki/Martin_Luther_King][Martin Luther King (1929-1968)]]
  + Nada en el mundo es más peligroso que la ignorancia sincera y la
    estupidez concienzuda.
  + Nuestras vidas comienzan a terminar el día en que guardamos silencio
...
* [[https://es.wikipedia.org/wiki/Maurice_Maeterlinck][Maurice Maeterlinck (1862-1949)]]
...
* [[https://es.wikipedia.org/wiki/Maurice_Merleau-Ponty][Maurice Merleau-Ponty (1908-1961)]]
  + El lenguaje vive del silencio; el silencio es el fondo sobre el cual
    se recorta la palabra.

* [[https://es.wikipedia.org/wiki/Max_Aub][Max Aub (1903-1972)]]
  + Siempre se puede escoger. Uno escoge siempre. Aunque no
    quiera. Vivir es escoger.

* [[https://es.wikipedia.org/wiki/Max_Planck][Max Planck (1858-1947)]]
...
* [[https://es.wikipedia.org/wiki/Michel_de_Montaigne][Michel de Montaigne (1533-1592)]]
  ...
  + Cuando me asaltan los pensamientos sombríos, nada me ayuda tanto
  ...
  + El alma que no tiene un fin establecido se pierde; pues, como suele
    decirse, estar en todas partes es no estar en lugar alguno.
  + Hay que reservarse una trastienda del alma, enteramente nuestra,
    donde establezcamos nuestra verdadera libertad, nuestro principal
    retiro y nuestra soledad.
  + La mejor cosa del mundo es saber estar consigo mismo.
  ...
  + Nada es inútil en la naturaleza, ni siquiera la inutilidad.
  ...
  + Nuestro deseo desprecia y abandona lo que tenemos para correr detrás
    de lo que no tenemos.
  + No hay cosa de la que tenga tanto miedo como del miedo.
  + Saber es saber que no se sabe nada.
...
* [[https://es.wikipedia.org/wiki/Michel_Foucault][Michel Foucault (1926-1984)]]
  ...
  - El pez nunca descubre que vive en el agua. De hecho, porque vive
    inmerso en ella, su vida transcurre sin advertir su existencia, de
    igual forma, cuando una conducta es normalizada por un ambiente
    cultural dominante, se vuelve invisible.

* [[https://en.wikipedia.org/wiki/Michel_Houellebecq][Michel Houellebecq (1956-)]]
  + Aumentar los deseos hasta un nivel insoportable y hacer cada vez más
    difícil su satisfacción: este era el principio único en el que se
    basaba la sociedad occidental.
...
* [[https://es.wikipedia.org/wiki/Miguel_Delibes][Miguel Delibes (1920-2010)]]
  + Alimentados de pesimismo no vivimos la vida, la sufrimos.
  + La máquina ha venido a calentar el estómago del hombre pero ha
    enfriado su corazón.
  + La medicina ha prolongado nuestra vida, pero no nos ha facilitado
...
* [[https://en.wikipedia.org/wiki/Milan_Kundera][Milan Kundera (1929-2023)]]
  + Hace tiempo que nos dimos cuenta de que ya no era posible dar la
    vuelta a este mundo, ni remodelarlo, ni detener su desafortunado
    curso hacia adelante. Sólo había una resistencia posible: no tomarlo
    en serio.
  + La lentitud es una forma de resistencia al mundo frenético que
    vivimos.
...
* [[https://es.wikipedia.org/wiki/Montesquieu][Montesquieu (1689-1755)]]
  ...
  + Si nos bastase con ser felices, la cosa sería facilísima; pero
    queremos ser más felices que los demás, y esto es casi siempre
    imposible, porque creemos que los demás son bastante más felices de
    lo que son en realidad.
  + Una cosa no es justa por el hecho de ser ley. Debe ser ley porque es
    justa.

* [[https://www.quotegarden.com/blog-who-is-muriel-strode.html][Muriel Strode (1875-1964)]]
  + No seguiré por donde el camino pueda llevarme; iré donde no haya
    camino y dejaré un sendero.
...
* [[https://es.wikipedia.org/wiki/Napole%C3%B3n_Bonaparte][Napoleón Bonaparte (1769-1821)]]
  + Cuando quiero que un asunto no se resuelva lo encomiendo a un
    comité.
  + Es más fácil engañar que desengañar.
  + La mejor cura para el cuerpo es una mente tranquila.
  + La razón por la que la mayoría de las personas fracasan en lugar de
    tener éxito, es que intercambian lo que más desean por lo que
    quieren en este momento.
  + La religión es excelente para mantener a la gente en silencio. La
    religión es lo que impide que los pobres asesinen a los ricos.
  + Los sabios son los que buscan la sabiduría; los necios piensan ya
    haberla encontrado.
  + No hay que temer a los que tienen otra opinión, sino a aquellos que
...
* [[https://es.wikipedia.org/wiki/Nicol%C3%A1s_Maquiavelo][Nicolás Maquiavelo (1469-1527)]]
  ...
  + Quien controla el miedo de la gente, se convierte en el amo de sus
    almas.
  + Todos ven lo que aparentas, pero pocos sienten lo que eres.

* [[https://es.wikipedia.org/wiki/Nikol%C3%A1i_G%C3%B3gol][Nikolái Gógol (1809-1852)]]
  + Se deben leer muchos libros para darse cuenta de lo poco que uno
    sabe.

* [[https://es.wikipedia.org/wiki/Nikos_Kazantzakis][Nikos Kazantzakis (1883-1957)]]
  + He dejado de acordarme de lo que ayer ocurrió y de preguntarme qué
    ocurrirá mañana. Lo que ocurre hoy, en el minuto presente, es lo que
    me interesa.
...
* [[https://es.wikipedia.org/wiki/Oscar_Wilde][Oscar Wilde (1854-1900)]]
  ...
  + El egoísmo no es vivir como uno desea vivir, es pedir a los demás
    que vivan como uno desea vivir. Y la generosidad consiste en dejar
    tranquila la vida de los demás, sin interferir en ella.
  ...
  + Un cínico es un hombre que conoce el precio de todo y no da valor a
    nada.
  + Vivimos en una época en la que las cosas innecesarias son nuestras
    únicas necesidades.
  + Vivir es la cosa menos frecuente en el mundo. La mayoría de la gente
    existe, eso es todo.
...
* [[https://es.wikipedia.org/wiki/Pablo_Picasso][Pablo Picasso (1881-1973)]]
  ...
  + El propósito del arte es limpiar el polvo de la vida diaria de
    nuestras almas.
  + Hace falta mucho tiempo para llegar a ser joven.
  ...
  + Siempre estoy haciendo lo que no puedo hacer, para poder aprender a
    hacerlo.

* [[https://es.wikipedia.org/wiki/Parm%C3%A9nides_de_Elea][Parménides de Elea (Siglo V a.C.)]]
  + Lo que es, es; y lo que no es, no es. Este es el único camino de la
    verdad.
...
* [[https://es.wikipedia.org/wiki/Paul_Val%C3%A9ry][Paul Valéry (1871-1945)]]
  + El problema de nuestros tiempos es que el futuro ya no es lo que
    era.
  + La guerra es una masacre de gentes que no se conocen, en provecho de
...
* [[https://es.wikipedia.org/wiki/P%C3%ADo_Baroja][Pío Baroja (1872-1956)]]
...
* [[https://es.wikipedia.org/wiki/Pit%C3%A1goras][Pitágoras (-570, -490)]]
  ...
  + Las palabras más antiguas y cortas, «sí» y «no», son las que
  ...
  + Sobre todas las cosas pueden hacerse dos afirmaciones totalmente
    contrarias.
  + Tú verás que los males de los hombres son fruto de su elección; y
    que la fuente del bien la buscan lejos, cuando la llevan dentro de
    su corazón.

* [[https://es.wikipedia.org/wiki/Plat%C3%B3n][Platón (427-347 a.C.)]]
...
* [[https://es.wikipedia.org/wiki/Plinio_el_Viejo][Plinio el Viejo (23-79)]]
  + Los hombres son más propensos a creer lo que menos entienden.
  + La esperanza es el pilar que sostiene al mundo. La esperanza es el
    sueño del hombre despierto.
  + La única certeza es que nada es seguro.

* [[https://es.wikipedia.org/wiki/Plotino][Plotino (205-270)]]
...
* [[https://es.wikipedia.org/wiki/Rabindranath_Tagore][Rabindranath Tagore (1861-1941)]]
  ...
  + El hombre se adentra en la multitud por ahogar el clamor de su
    propio silencio.
  + Ese que habla tanto está completamente hueco, ya sabes que el
    cántaro vacío es el que más suena.
  + ¿Estás triste? Busca a otra persona triste y consuélala: encontrarás
    la alegría.
  + Hacer preguntas es prueba de que se piensa.
  + Leemos mal el mundo y decimos luego que nos engaña.
  + Si lloras de noche porque has perdido el sol, las lágrimas no te
...
* [[https://es.wikipedia.org/wiki/Rainer_Maria_Rilke][Rainer María Rilke (1875-1926)]]
  + El amor consiste en esto: en que dos soledades se protejan,
    deslinden y se saluden.
  + La belleza está en los detalles, en las pequeñas cosas que pasamos
    por alto.
  + La verdadera felicidad no se encuentra en la meta, sino en el camino
    que recorremos para llegar a ella.
  + ¿No estamos aquí para transformarnos en nosotros mismos?
  + No hay mayor acto de valentía que ser uno mismo en un mundo que
    constantemente trata de cambiarnos.
...
* [[https://es.wikipedia.org/wiki/Ralph_Waldo_Emerson][Ralph Waldo Emerson (1803-1882)]]
  ...
  + Es fácil en el mundo vivir según la opinión del mundo; es fácil en
    la soledad vivir según la nuestra; pero el gran hombre es aquel que
    en medio de la multitud mantiene con perfecta sencillez la
  ...
  + Por cada minuto que estás enojado, pierdes sesenta segundos de
    felicidad.
  + Ser uno mismo en un mundo que intenta incesantemente convertirte en
    otra cosa es la mayor de las proezas.
...
* [[https://es.wikipedia.org/wiki/Rembrandt][Rembrandt (1606-1669)]]
...
* [[https://es.wikipedia.org/wiki/Ren%C3%A9_Descartes][René Descartes (1596-1650)]]
  + Abrigamos una multitud de prejuicios si no nos decidimos a dudar,
    alguna vez, de todas las cosas en que encontremos la menor sospecha
    de incertidumbre.
  ...
  + Conviene tener en cuenta que muchas creencias se apoyan en el
...
* [[https://es.wikipedia.org/wiki/Robert_Frost][Robert Frost (1874-1963)]]
...
* [[https://en.wikipedia.org/wiki/Robert_Frost][Robert Frost (1874-1963)]]
  + La mitad del mundo tiene algo que decir, pero no puede; la otra
    mitad no tiene nada que decir, pero no calla.
...
* [[https://es.wikipedia.org/wiki/Roberto_Bola%C3%B1o][Roberto Bolaño (1953-2003)]]
...
* [[https://es.wikipedia.org/wiki/Rosa_Luxemburgo][Rosa Luxemburgo (1871-1919)]]
...
* [[https://es.wikipedia.org/wiki/Rub%C3%A9n_Dar%C3%ADo][Rubén Darío (1867-1916)]]
...
* [[https://es.wikipedia.org/wiki/Rudyard_Kipling][Rudyard Kipling (1865-1936)]]
  + El individuo siempre ha tenido que luchar para no ser absorbido por
...
* [[https://es.wikipedia.org/wiki/Yalal_ad-Din_Muhammad_Rumi][Rumí (1207-1273)]]
...
* [[https://es.wikipedia.org/wiki/Agust%C3%ADn_de_Hipona][San Agustín (354-430)]]
  ...
  + Cada edad, desde la infancia hasta la vejez, tiene en cada uno de
    los hombres su propia hermosura.
...
* [[https://es.wikipedia.org/wiki/Santiago_Ram%C3%B3n_y_Cajal][Santiago Ramón y Cajal (1952-1934)]]
  + Digan lo que quieran los ricos viciosos y los holgazanes
    incorregibles, el trabajo agradable y útil resulta todavía la mejor
  ...
  + Lo peor no es cometer un error, sino tratar de justificarlo, en vez
    ...
    ignorancia.
  + Nada me inspira más veneración y asombro que un anciano que sabe
    cambiar de opinión.
  ...
  + Si hay algo en nosotros verdaderamente divino, es la voluntad. Por
    ella afirmamos la personalidad, templamos el carácter, desafiamos la
    adversidad, reconstruimos el cerebro y nos superamos diariamente.
  ...
  + Una de las desdichas de nuestro país consiste, como se ha dicho
    hartas veces, en que el interés individual ignora el interés
    colectivo.
...
* [[https://es.wikipedia.org/wiki/Shunryu_Suzuki][Shunryu Suzuki (1904-1971)]]
  ...
  + En la mente del principiante hay muchas posibilidades; en la del
    experto, pocas.
  + Trata cada momento como si fuera el último. No es preparación para
    otra cosa.

* [[https://es.wikipedia.org/wiki/Sigmund_Freud][Sigmund Freud (1856-1939)]]
  + ¡Estudia! No para saber una cosa más, sino para saberla mejor.
  ...
  + Tal vez haya algo peor que los sueños desvanecidos: perder la
    voluntad de volver a soñar.
  + Uno es dueño de lo que calla y esclavo de lo que habla.

* [[https://es.wikipedia.org/wiki/Simone_de_Beauvoir][Simone de Beauvoir (1908-1986)]]
...
* [[https://es.wikipedia.org/wiki/Simone_Weil][Simone Weil (1909-1943)]]
  + Dar lo que se sabe es la única manera de estar seguro de que se
    sabe. El saber retenido es un saber muerto.
  + Echar raíces es quizá la necesidad más importante e ignorada del
    alma humana.
  + El apego es el gran fabricante de ilusiones; la realidad solo puede
    ser alcanzada por alguien que está desapegado.
  + La alegría es una necesidad esencial del alma. La falta de alegría,
    ya se trate de desgracia o simplemente de aburrimiento, es un estado
    de enfermedad en la que la inteligencia, la valentía, la generosidad
    se apagan.
  + La atención es la forma más rara y pura de generosidad.

* [[https://es.wikipedia.org/wiki/S%C3%B3crates][Sócrates (479-399 a.C.)]]
  + Con cordura y buen humor, la vejez es soportable; pero con un
    carácter opuesto, lo mismo la vejez que la juventud son
    desgraciadas.
  ...
  + El paso del tiempo arruga tu piel, pero la falta de entusiasmo
    arruga tu alma.
  + El silencio es una profunda melodía, para todos aquellos que pueden
    escucharla por encima de todo el ruido.
  ...
  + Quien tiene un carácter tranquilo y feliz difícilmente sentirá la
    presión de la edad. Pero para quien tiene una disposición opuesta,
    la juventud y la edad son igualmente una carga.
...
* [[https://es.wikipedia.org/wiki/Sol%C3%B3n][Solón (c. 638 a.C. - 558 a.C.)]]
  + Conócete a ti mismo.
  + Hay que ocupar en todo el justo medio.
  + Me hago viejo aprendiendo siempre multitud de cosas.
  + Nada en exceso.

* [[https://es.wikipedia.org/wiki/Sor_Juana_In%C3%A9s_de_la_Cruz][Sor Juana Inés de la Cruz (1648-1695)]]
...
* [[https://es.wikipedia.org/wiki/S%C3%B8ren_Kierkegaard][Søren Kierkegaard (1813-1855)]]
  + Afronta el hecho de ser lo que eres, porque eso es lo que cambia lo
    que eres.
  + El instante es esa ambigüedad en que el tiempo y la eternidad se
    tocan, y con esto queda planteado el concepto de temporalidad, en el
    que el tiempo no cesa de cortar la eternidad y la eternidad no cesa
    de penetrar el tiempo.
  + Es del todo cierto lo que dice la filosofía: que la vida debe
    comprenderse hacia atrás. Pero con ello se olvida la otra
    proposición: que debe vivirse hacia adelante; y cuanto más se medita
    en ello, más evidente se hace que la vida en la temporalidad nunca
    llega a ser plenamente comprensible, precisamente porque en ningún
    momento encuentro un reposo completo desde el cual volverme hacia
    atrás.
  ...
  + La forma más común de desesperación es no querer ser uno mismo; la
    más profunda, querer ser otro.
  ...
  + La ironía es la agudeza que libera al espíritu.
  ...
  + La esperanza es una pasión por lo posible.
  + La paciencia es necesaria; uno no puede cosechar inmediatamente allí
    donde ha sembrado.
  + La tarea se debe plantear difícil, pues sólo la dificultad inspira a
    los nobles de corazón.
  + La vida solo puede ser comprendida hacia atrás, pero debe ser vivida
    hacia adelante.
  + Lo que me falta es, propiamente, que el mundo sea una farsa, y yo el
    único que lo percibe.
...
* [[https://es.wikipedia.org/wiki/Stefan_Zweig][Stefan Zweig (1881-1942)]]
  + Urge volver a creer en el mundo, en la humanidad.
...
* [[https://es.wikipedia.org/wiki/Steve_Jobs][Steve Jobs (1955-2011)]]
  + Tu tiempo es limitado, así que no lo malgastes viviendo la vida de
    otro. No te dejes atrapar por el dogma, que no es más que vivir con
    los resultados del pensamiento ajeno. No dejes que el ruido de las
    opiniones de los demás ahogue tu propia voz interior. Y lo más
    importante: ten el valor de seguir tu corazón y tu intuición. De
    algún modo, ellos ya saben en qué quieres convertirte
    verdaderamente.
...
* [[https://bit.ly/38qowDp][Swami Vivekananda (1863-1902)]]
  ...
  + Toma una idea. Haz de esa idea tu vida: piénsala, sueña con ella,
    vive de esa idea. Deje que el cerebro, los músculos, los nervios y
    cada parte de su cuerpo se llenen de esa idea y deje todas las demás
    ideas en paz. Este es el camino al éxito.

* [[https://es.wikipedia.org/wiki/T%C3%A1cito][Tácito]]
  + Todo lo que se ignora tiende a magnificarse.

* [[https://es.wikipedia.org/wiki/Tales_de_Mileto][Tales de Mileto (aprox. 624-546 a.C.)]]
...
* [[https://es.wikipedia.org/wiki/Terencio][Terencio (185-159 a.C.)]]
  + Cuando no se puede lograr lo que se quiere, mejor cambiar de
    actitud.
  + Hombre soy; nada humano me es ajeno (/Homo sum; humani nihil a me
    alterum puto/).
...
* [[https://es.wikipedia.org/wiki/Thomas_Alva_Edison][Thomas Alva Edison (1847-1931)]]
  + Hay una manera de hacerlo mejor, búscala.
  + No he fracasado, he encontrado diez mil soluciones que no funcionan.
  + Nuestra mayor debilidad es rendirnos. La forma más segura de tener
...
* [[https://es.wikipedia.org/wiki/Thomas_Jefferson][Thomas Jefferson (1746-1823)]]
  + He renunciado a los periódicos a cambio de Tácito y Tucídides, de
    Newton y Euclides; y me siento mucho más feliz.
  + Nada da tanta ventaja a una persona sobre otra como permanecer
    siempre tranquila y serena en todas las circunstancias.
...
* [[https://es.wikipedia.org/wiki/Thomas_Kuhn][Thomas Kuhn (1922-1996)]]
...
* [[https://es.wikipedia.org/wiki/Thomas_Mann][Thomas Mann (1875-1955)]]
  + La verdadera sabiduría radica en reconocer nuestras propias
    limitaciones.

* [[https://es.wikipedia.org/wiki/Thomas_Merton][Thomas Merton]]
  + La felicidad no es una cuestión de intensidad, sino de equilibrio,
    ritmo y armonía.
  + La música es agradable no sólo por el sonido, sino por el silencio
    que hay en ella: sin la alternancia entre el sonido y el silencio no
    habría ritmo.
...
* [[https://es.wikipedia.org/wiki/Tito_Livio][Tito Livio (-59, -17)]]
...
* [[https://es.wikipedia.org/wiki/Tom%C3%A1s_de_Kempis][Tomás de Kempis (1380-1491)]]
  + Busqué el descanso en todas las cosas, y en ninguna lo encontré,
    sino en un rincón con un libro.
...
* [[https://es.wikipedia.org/wiki/Truman_Capote][Truman Capote (1924-1984)]]
  ...
  + Siempre hacen más ruido las latas vacías que las llenas. Lo mismo
    ocurre con los cerebros.
...
* [[https://es.wikipedia.org/wiki/Umberto_Eco][Umberto Eco (1932-2016)]]
...
* [[https://es.wikipedia.org/wiki/Victor_Hugo][Victor Hugo (1802-1885)]]
  ...
  + La verdad es como el sol: hace que todo se vea y no se deja mirar.
...
* [[https://es.wikipedia.org/wiki/Viktor_Frankl][Viktor Frankl (1905-1997)]]
  ...
  + El destino no puede ser cambiado; de lo contrario, no sería
    destino. El hombre, no obstante, puede cambiarse a sí mismo, de lo
    contrario no sería un hombre.
  + El hombre en busca de sentido.
  + El hombre sólo puede sobrevivir cuando da una orientación a su vida,
    y en mi opinión esto es válido, no sólo respecto a la supervivencia
    del individuo sino respecto a la supervivencia de la humanidad
    entera.
  + El humor es otra de las armas con las que el alma lucha por su
    supervivencia.
  ...
  + Si no está en tus manos cambiar una situación que te produce dolor,
    ...
    sufrimiento.
  + Sólo existe una manera de hacer frente a la vida: tener siempre una
    tarea que cumplir.
...
* [[https://es.wikipedia.org/wiki/Virgilio][Virgilio (-10, -19)]]
...
* [[https://en.wikipedia.org/wiki/Virginia_Woolf][Virginia Woolf (1882-1941)]]
  + Hay una especie de tristeza que surge cuando se sabe demasiado,
    cuando se ve el mundo como realmente es. Es la tristeza de
    comprender que la vida no es una gran aventura, sino una serie de
    pequeños e insignificantes momentos.
...
* [[https://es.wikipedia.org/wiki/Voltaire][Voltaire (1694-1778)]]
  ...
  + El hombre actual ha nacido o bien para vivir entre las convulsiones de
    la inquietud, o bien en el letargo del aburrimiento.
...
* [[https://es.wikipedia.org/wiki/Walter_Scott][Walter Scott (1771-1832)]]
...
* [[https://es.wikipedia.org/wiki/William_Blake][William Blake (1757-1827)]]
...
* [[https://es.wikipedia.org/wiki/William_Faulkner][William Faulkner (1897-1962)]]
...
* [[https://es.wikipedia.org/wiki/William_Shakespeare][William Shakespeare (1565-1616)]]
  ...
  + Todo el mundo es un escenario, y todos, hombres y mujeres, son meros
    actores. Todos tienen sus entradas y salidas, y cada hombre en su
    vida representa muchos papeles, siendo los actos siete edades.
...
* [[https://bit.ly/3itzT1w][William Somerset Maugham (1874-1965)]]
...
* [[https://es.wikipedia.org/wiki/William_Wordsworth][William Wordsworth (1770-1850)]]
  + La vida se divide en tres períodos; lo que era, lo que es y lo que
    será. Aprendamos del pasado para sacar provecho de la actualidad, y
    del presente para vivir mejor en el futuro.

* [[https://es.wikipedia.org/wiki/Winston_Churchill][Winston Churchill (1874-1965)]]
...
* [[https://es.wikipedia.org/wiki/Zen%C3%B3n_de_Citio][Zenón de Citio (334-262 a.C.)]]
  + La naturaleza nos dio dos oídos y una sola boca para que escuchemos
...
* [[https://es.wikipedia.org/wiki/Zygmunt_Bauman][Zygmunt Bauman (1925-2017)]]
  + Con nuestro culto a la satisfacción inmediata, muchos de nosotros
    hemos perdido la capacidad de esperar.
  + En nuestro mundo, todas las ideas de felicidad tienden a acabar en
    una tienda.
  + La injusticia moderna consiste en disfrutar de los frutos del
    trabajo ajeno sin tener que mirar a los ojos a quien los produjo.
