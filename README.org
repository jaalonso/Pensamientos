...
+ [[https://es.wikipedia.org/wiki/Herbert_Alexander_Simon][Herbert A. Simon]]
  ...
  + ¿Qué consume la información? Consume la atención de sus destinatarios. En
    ...
    sobreabundancia de fuentes de información que se pueda consumir es
    primordial.
...
+ [[https://es.wikipedia.org/wiki/Martin_Heidegger][Martin Heidegger]]
...
+ [[https://es.wikipedia.org/wiki/Richard_Courant][Richard Courant]] y [[https://en.wikipedia.org/wiki/Herbert_Robbins][Herbert Robbins]]
  ...
  + Las matemáticas, como expresión de la mente humana, reflejan la voluntad
    ...
    la generalidad y la individualidad. Aunque las diferentes tradiciones pueden
    enfatizar diferentes aspectos, es sólo la interacción de estas fuerzas
