...
* [[https://es.wikipedia.org/wiki/ConfVcio][Confucio]]
  ...
  + Podemos aprender la sabiduría por tres métodos: primero, por la
    reflexión, que es el más noble; segundo, por la imitación, que es el
    más fácil; y tercero por la experiencia, que es el más difícil.
...
* [[https://es.wikipedia.org/wiki/Miguel_de_Unamuno][Miguel de Unamuno]]
  ...
  + Nosotros somos los solitarios, y los solitarios todos se entienden
    entre sí. Sin hablarse, ni verse, ni siquiera conocerse. Me acompañan
    en mi soledad las soledades de los demás solitarios.
