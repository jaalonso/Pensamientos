...
+ [[https://es.wikipedia.org/wiki/Friedrich_Schiller][Friedrich Schiller]]
  + La utilidad es el gran ídolo de nuestra época [...]. Pero es el camino de la
    belleza el que conduce a la libertad.
...
+ [[https://es.wikipedia.org/wiki/Lao-Tse][Lao-Tse]]
  ...
  + No valores las cosas difíciles de obtener, verás que nadie se entregará a la
    codicia.
  + Preocúpate por lo que otras personas piensen, y siempre serás su
    prisionero.
